...
$this->fontdata = array(
	...
	"dejavusansmono" => array(
        ...
        'R' => "Verdana.ttf",
		'B' => "Verdana-Bold.ttf",
		'I' => "Verdana-Oblique.ttf",
		'BI' => "Verdana-BoldOblique.ttf",		
	
        ),
		"verdana" => array ( //da error de unicode tendriamos que meter simbolos 
        'R' => "Verdana.ttf",
		'B' => "Verdana-Bold.ttf",
		'I' => "Verdana-Oblique.ttf",
		'BI' => "Verdana-BoldOblique.ttf",		
		...
		"wingding" => array ( //da error de unicode tendriamos que meter simbolos 
        'R' => "Wingding.ttf",
        ),
        ...
        'R' => "Comicsansms.ttf",
		'B' => "Comicsansms-Bold.ttf",
        ),
			"arialblack" => array ( //He agregado esta fuente ya que su orden original no era leida ni interpretada.Con esto hemos añadido su respectivo TTF
...
//He puesto cambios para en caso de que existan errores se auto detecten ya que la pagina es probable que se ejecute con linux o mac
$this->sans_fonts = array('arialblack','dejavusanscondensed','dejavusans','freesans','liberationsans','sans','sans-serif','cursive','fantasy', 
				'arial','helvetica','verdana','geneva','lucida','arialnarrow','arialunicodems',
				'franklin','franklingothicbook','tahoma','garuda','calibri','trebuchet','lucidagrande','microsoftsansserif',
				'trebuchetms','lucidasansunicode','franklingothicmedium','albertusmedium','xbriyaz','albasuper','quillscript'

);

$this->serif_fonts = array('georgia','dejavuserif','freeserif','liberationserif','serif',
...
$this->mono_fonts = array('courier','freemono','liberationmono','courier', 'mono','monospace','ocrb','ocr-b','lucidaconsole',
