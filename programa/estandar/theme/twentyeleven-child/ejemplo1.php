<?php
$baseUrl = (isset($_GET['baseUrl'])) ? $_GET['baseUrl'] : 'wp-content/themes/twentyeleven-child';
?>
...
<form name="formImprimir" method="post" action="<?php echo $baseUrl; ?>/imprimir.php" target="_blank">
<input type="hidden" name="impContent" id="impContent" value="">
<input type="button" value="imprimir" onclick="imprimir();">
</form>
<script language="javascript">
	function imprimir() {
		document.getElementById("impContent").value = document.getElementById("miContenido").innerHTML;
		alert("html: " + document.getElementById("impContent").value);
