<?php
	...
	*/
	...
	if(!defined('BASE_RUTA')) define('BASE_RUTA', $myPath.'plugins/doconline/images/contenidos/');
	if(!defined('BASE_RUTA_HTTP')) define('BASE_RUTA_HTTP', $myUrl.'plugins/doconline/images/contenidos/');
